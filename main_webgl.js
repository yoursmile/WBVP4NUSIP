    ...
    function init_Config() {
        ...
        $("#camera").change(function() {
            ...
            if (c1 || c2) {
                ...
                sw_config['camera'][2] = Math.abs(c3);
                console.log(c3);
            } else {
                // dirty fix
                sw_config['camera'][0] = 0;
                sw_config['camera'][1] = 0.001;
                sw_config['camera'][2] = Math.abs(c3);
            }
            $("#camera").val(sw_config.camera[0].toFixed(2) + "," +
                sw_config.camera[1].toFixed(2) + "," +
                sw_config.camera[2].toFixed(2));
        });
        //鼠标滚轮操作
